...
- **[TwinX Kubernetes 1.35 업그레이드 계획](docs/TwinX-Kubernetes-Upgrade-Plan.md)**: Kubespray 기반 1.35.4 업그레이드, Hubble, DRA, 노드별 drain/PDB/Rook-Ceph/Partridge, rm352 Cilium, OTP preflight 전략
